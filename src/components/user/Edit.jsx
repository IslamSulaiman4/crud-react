...
if(loader){
 ...
 <div className="container-fluid">
  <div className="row flex-nowrap w-75">
...
<Input errors={errors} id={'username'} title={'User name'} type={'text'} value={user.name} name={'name'} handleChange={handleData}/>
<Input errors={errors} id={'email'} title={'Email'} type={'email'} value={user.email} name={'email'} handleChange={handleData}/>
<Input errors={errors} id={'password'}  title={'Password'} type={'password'} value={user.password} name={'password'} handleChange={handleData}/>
