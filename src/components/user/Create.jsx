...
<Input errors={errors} id={'username'} title={'User name'} type={'text'}  name={'name'} handleChange={handleData}/>
<Input errors={errors} id={'email'} title={'Email'} type={'email'} value={user.email} name={'email'} handleChange={handleData}/>
<Input errors={errors} id={'password'}  title={'Password'} type={'password'}  name={'password'} handleChange={handleData}/>
